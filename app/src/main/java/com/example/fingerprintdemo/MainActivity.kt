...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(!fm.hasEnrolledFingerprints()) {
            Toast.makeText(this, "Refister at least one fingerprint", Toast.LENGTH_SHORT).show()
            return
        }
    ...
    @RequiresApi(Build.VERSION_CODES.M)
    private fun validateFingerPrint() {  //generating key
        try {
        ...
        if(::fm.isInitialized && ::cryptoObject.isInitialized) {
